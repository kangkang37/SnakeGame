...
# Use Bayesian optimization to search for the best hyperparameter combination for the reinforcement learning algorithm.
# Execute training and evaluation by calling the run function, and update the parameter values based on the evaluation results.
...
class BayesianOptimizer():
    ...
    def optimize_RL(self):
        ...
        # The optimal combination of these parameters will be selected.
        optim_params = [
        ...
        # The range of values for the domain parameters.
        # If the parameter type is continuous, specify a tuple containing two elements representing the minimum and maximum values of the parameter.
        # If the parameter type is discrete, specify a tuple or list containing multiple elements representing the discrete values the parameter can take.
        # These parameters will be used in the Bayesian optimization process to search for the best parameter combination within the given parameter space.
        # Based on the parameter type and range, the optimizer will search and optimize within the specified range.
