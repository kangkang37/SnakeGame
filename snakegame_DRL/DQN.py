...
class DQNAgent(torch.nn.Module):
    ...
    def network(self):
        '''
        Four linear layers are defined, namely self.f1, self.f2, self.f3, and self.f4, instantiated using the nn.Linear function.
        '''
        # Layers
        ...
        if self.load_weights:
            '''
            If self.load_weights is set to True, pre-trained weights are loaded by calling the load_state_dict function.
            The weights are saved in the weights folder.
            '''
